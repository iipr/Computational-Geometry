...
class LDA:
    ...
    def fit(self, X_train, y_train, reduced_dim):
        ...
        --------
        my_lda = LDA()
        X_train = np.asarray([[34.12, 31.05, -5.98], 
        [-17.21, -28.20, 17.54], [36.76, 26.94, -6.18], 
        [-37.79, -1.14, -1.37], [34.65, 29.18, -6.29], 
        [-18.57, 28.66, 18.45]])
        y_train = np.asarray([0, 1, 2, 2, 1, 0])
        reduced_dim = 2
        my_lda.fit(X_train, y_train, reduced_dim)

        The projecting matrix resulting:
    ...
    def transform(self, X):
        ...
        [34.06, 25.76, -5.19], [-16.56, -28.34, 19.55], 
...
class PCA:
    ...
    def fit(self, X_train, reduced_dim):
        ...
        X_train = np.asarray([[34.12, 31.05, -5.98], [-17.21, -28.20, 17.54], 
         [36.76, 26.94, -6.18], [-37.79, -1.14, -1.37], 
         [34.65, 29.18, -6.29], [-18.57, 28.66, 18.45]])
        ...
        X_train = np.asarray([[34.12, 31.05, -5.98,-17.21, -28.20], 
         [36.76, 26.94, -6.18, -1.14, -1.37], [34.65, 29.18, -6.29, 28.66, 18.45]])
    ...
    def transform(self, X):
        ...
        Examples
        --------
        Introduce some values for X:
            >>> X = np.asarray([[-36.61, -0.95, -27.53], [34.06, 25.76, -5.19], 
        ...
        Now with a different X:
            >>> X = np.asarray([[-36.61, -0.95, -27.53, 25.76, -5.19], 
